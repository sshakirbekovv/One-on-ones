    ...
    <Container>
      ...
      <Col xl={6} lg={6} className="order-mobile-1">
        <div className="consultation__info">
              <h1>Консультации от Райхан</h1>
              <ul>
                <li>– Программист в Фейсбуке в Лондоне</li>
                <li>– Выпускник Назарбаев Университета</li>
              </ul>
              <div>
              <a 
                href="https://calendly.com/raihassen/consultation"
                target="_blank" 
        ...
        <Col xl={5} lg={6} sm={12} className="order-mobile-0 d-flex justify-content-center align-items-center mt-md-5">
          <div className="consultation__photo RaykhanMain"></div>
        </Col>
       </Row>
    </Container>
    </section>
    ...
    <Container>
        <div className="experience__content">
          ...
          <ul>
            <li>Про меня:</li>
            <li>• Программист в Фейсбуке в Лондоне</li>
            <li>• Стажировалась в Гугле(2016), стартапе ParkFlyRent(2017), Facebook(2018)</li>
            <li>• Выпускник Назарбаев Университета, занималась научной деятельностью (публикация: Saudabayev, A., Rysbek, Z., Khassenova, R. et al. Human grasping database for activities of daily living with depth, color and kinematic data streams. Sci Data 5, 180101 (2018). https://doi.org/10.1038/sdata.2018.101 )</li>
          </ul>
        </div>
    </Container>
    </section>
